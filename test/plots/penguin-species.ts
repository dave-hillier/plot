...
export async function penguinSpeciesCheysson() {
  ...
  return React.createElement(Plot, {
    ...
    React.createElement(BarY, {data: penguins, ...groupX({y: "count"}, {x: "species", fill: "species", inset: 3})}),
    React.createElement(BarY, {data: penguins, ...groupX({y: "count"}, {x: "species", stroke: "currentColor"})}),
...
export async function penguinSpeciesGradient() {
  ...
  return React.createElement(Plot, {},
    ...
    React.createElement(BarY, {data: penguins, ...groupX({y: "count"}, {x: "species", fill: "url(#gradient)"})}),
    React.createElement(RuleY, {data: [0]})
  );
}
...
export async function penguinSpeciesGroup() {
  const penguins = await d3.csv<any>("data/penguins.csv", d3.autoType);
  return React.createElement(Plot, {},
    React.createElement(BarX, {data: penguins, ...stackX(groupZ({x: "proportion"}, {fill: "species"}))}),
    React.createElement(Text, {data: penguins, ...stackX(groupZ({x: "proportion", text: "first"}, {z: "species", text: "species"}))}),
