...
export async function googleTrendsRidgeline() {
  ...
  return React.createElement(Plot, {
    ...
    React.createElement(AreaY, {data, x: "week", y: "interest", fillOpacity: 0.3, sort: {fy: "y", reduce: "max-index"}}),
    React.createElement(Line, {data, x: "week", y: "interest", stroke: "white", strokeWidth: 1}),
