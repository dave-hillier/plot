...
export async function pointerLinkedRectInterval() {
  ...
  return React.createElement(Plot, {},
    React.createElement(Rect, {data: series, ...pointerX({x: "time", interval: round, fillOpacity: 0.1})}),
    React.createElement(LineY, {data: series, stroke: "series", x: "time", y: "value", marker: true, curve: "natural"}),
    React.createElement(Arrow, {data: series, ...pointerX(groupX({y1: "min", y2: "max"}, {x: "time", y: "value", inset: 10}))})
  );
}
