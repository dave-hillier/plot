import {BarY, Cell, CellX, Dot, Frame, LineY, Plot, RuleX, RuleY, TickX, identity, scale} from "replot/react";
...
export const goog = [];
export const sftemp = [];
export const schemeq = "turbo";
export const interpolateq = "rgb";
export const schemed = "rdbu";
export const schemeo = "Observable10";
export const padding = 0.5;
export const align = 0.5;
export const radius = 5;
export const intervaled = true;
export const setSchemeq = () => {};
export const setInterpolateq = () => {};
export const setSchemed = () => {};
export const setSchemeo = () => {};
export const setPadding = () => {};
export const setAlign = () => {};
export const setRadius = () => {};
export const setIntervaled = () => {};
export const color = {domain: ["apple", "orange", "pear"], apply: () => "#4e79a7"};

{/*
// TODO: manually convert: const anomaly = gistemp.map((d) => d.Anomaly);
*/}
...
{/* TODO: Plot.plot({x: {domain: [0, 100], grid: true}}...) */}

Flipping the domain reverses the scale so that +*x* points ←left instead of right→.

{/* TODO: Plot.plot({x: {domain: [100, 0], grid: true}}...) */}
...
{/* TODO: Plot.plot({x: {domain: [0, 100], reverse: true, grid: true}}...) */}
...
{/* TODO: Plot.plot({x: {domain: [new Date("2021-01-01"), new Date("2022-01-01")...) */}
...
{/* TODO: Plot.plot({x: {type: "utc", domain: [1609459200000, 1640995200000], gr...) */}

If the scale **type** is *time*, the ticks will be in local time — as with the dates below — rather than UTC.

{/* TODO: Plot.plot({x: {type: "time", domain: [new Date(2021, 0, 1), new Date(2...) */}
...
{/* TODO: Plot.plot({x: {type: "log", domain: [1e0, 1e5], grid: true}}...) */}
...
{/* TODO: Plot.plot({x: {type: "log", domain: [1e0, 1e5], tickFormat: ",", grid:...) */}
...
{/* TODO: Plot.plot({x: {type: "log", base: 2, domain: [1e0, 1e4], ticks: 20, gr...) */}
...
{/* TODO: Plot.plot({x: {type: "symlog", domain: [-10, 10], grid: true}}...) */}
...
{/* TODO: Plot.plot({x: {type: "sqrt", domain: [0, 100], grid: true}}...) */}

{/* TODO: Plot.plot({x: {type: "pow", exponent: 1 / 3, domain: [0, 100], grid: t...) */}
...
{/* TODO: Plot.plot({x: {type: "point", domain: "ABCDEFGHIJ", grid: true}}...) */}
...
{/* Plot
  .cell("ABCDEFGHIJ", {x: identity, stroke: "currentColor", strokeOpacity: 0.1})
...
<Plot axis={null} padding={0} color={{
    scheme: schemeq
  }}>
...
{/* TODO: Plot.plot({x: {domain: [new Date("1880-01-01"), new Date("2016-11-01")...) */}
...
<Plot width={322} height={25 * 27} margin={0} marginRight={70} padding={0} x={{axis: null}} y={{axis: "right", tickSize: 0}} color={{type: "identity"}}>
  <Cell data={[
...
<Plot width={322} height={25 * 11} margin={0} marginRight={70} padding={0} x={{axis: null}} y={{axis: "right", tickSize: 0}} color={{type: "identity"}}>
  <Cell data={[
...
<Plot width={322} height={25 * 2} margin={0} marginRight={70} padding={0} x={{axis: null}} y={{axis: "right", tickSize: 0}} color={{type: "identity"}}>
  <Cell data={[
...
<Plot width={322} height={25 * 10} margin={0} marginRight={70} padding={0} x={{axis: null}} y={{axis: "right", tickSize: 0}} color={{type: "identity"}}>
  <Cell data={[
...
## scale(*options*) <VersionBadge version="0.4.0" />
