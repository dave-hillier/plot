import {formatMonth, formatWeekday, Plot, TextX} from "replot/react";
...
## formatNumber(*locale*) <VersionBadge version="0.6.15" pr="2078" />
```js
...
<Plot x={{tickFormat: formatWeekday()}}>
...
<Plot x={{tickFormat: formatMonth(), ticks: 12}}>
