import {BinX, Cell, Group, GroupY, NormalizeY, Plot, RectY, RuleX, TickX, identity, valueof, column, indexOf, scale} from "replot/react";
...
<Plot marginLeft={120} x={{label: "Vehicles per hour (thousands)", transform: (x) => x / 1000}} y={{label: null}}>
  ...
  <GroupY x="median">
    <TickX data={traffic} x="vehicles" y="location" stroke="red" strokeWidth={4} sort={{y: "x"}} />
  </GroupY>
</Plot>
...
<Plot marginLeft={120} padding={0} y={{label: null}} color={{scheme: "turbo", legend: true, zero: true}}>
  <Group fill="median">
    <Cell data={traffic} x={(d) => d.date.getUTCHours()} y="location" fill="vehicles" inset={0.5} sort={{y: "fill"}} />
  </Group>
</Plot>
...
<Plot color={{legend: true}}>
  <BinX y="count">
    <RectY data={olympians} x="weight" fill="sex" />
  </BinX>
</Plot>
...
<Plot y={{percent: true}}>
  ...
  <NormalizeY basis="sum">
    <BinX y2="count">
      <RectY data={olympians} x="weight" fill="sex" mixBlendMode="multiply" />
    </BinX>
  </NormalizeY>
</Plot>
