import {BinX, Cell, Group, GroupY, NormalizeY, Replot, RectY, RuleX, TickX, identity, valueof, column, indexOf, scale} from "replot/react";
...
<Replot marginLeft={120} padding={0} y={{label: null}} color={{scheme: "turbo", legend: true, zero: true}}>
  <Group fill="median">
