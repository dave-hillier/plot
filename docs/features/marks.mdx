...
<Plot>
  {/* TODO: [goog, aapl].map((stock) => Plot.lineY(stock, {x: "Date", y: "Close"})) */}
</Plot>
...
<Plot>
  ...
  <BarY data={alphabet} x="letter" y="frequency" fill="url(#gradient)" />
  <RuleY data={[0]} />
</Plot>
...
<Plot>
  <RuleY data={[0]} />
  {/* TODO: area ? Plot.areaY(aapl, {x: "Date", y: "Close", fillOpacity: 0.2}) : null */}
  <LineY data={aapl} x="Date" y="Close" />
</Plot>
