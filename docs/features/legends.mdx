import {Dot, Plot, RuleY} from "replot/react";
...
// TODO: manually convert: const gistemp = shallowRef([

// TODO: manually convert: {Date: new Date("2016-12-01"), Anomaly: 1.35}
...
{/* TODO: PlotRender - manually convert: color: {type: "linear"}, defer method="legend" */}
...
{/* TODO: PlotRender - manually convert: width: 320, color: {type: "linear"}, defer method="legend" */}
