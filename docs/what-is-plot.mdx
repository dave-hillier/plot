import {Bin, BinX, Density, Dot, Plot, Rect, RectY, RuleY} from "replot/react";
...
<Plot>
  <Bin fillOpacity="count">
    <Rect data={olympians} x="weight" y="height" fill="sex" inset={0} />
  </Bin>
</Plot>
...
<Plot grid>
  <BinX y="count">
    <RectY data={olympians} x="weight" fill="sex" fy="sex" />
  </BinX>
  <RuleY data={[0]} />
</Plot>
