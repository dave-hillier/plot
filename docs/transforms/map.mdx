import {AreaY, LineY, Plot, RuleY, map, mapY, windowY} from "replot/react";
...
<Plot>
  <RuleY data={[0]} />
  <LineY data={{length: 600}} {...mapY("cumsum", {y: d3.randomNormal.source(d3.randomLcg(42))()})} />
</Plot>
...
<Plot>
  <RuleY data={[0, 1]} />
  <LineY data={aapl} {...mapY("quantile", {x: "Date", y: "Volume", strokeOpacity: 0.2})} />
  <LineY data={aapl} {...windowY(30, Plot.mapY("quantile", {x: "Date", y: "Volume"}))} />
</Plot>
...
<Plot y={{
  ...
  <AreaY data={aapl} {...map({y1: Plot.bollinger({n, k: -k}), y2: Plot.bollinger({n, k})}, {x: "Date", y: "Close", fillOpacity: 0.2})} />
  <LineY data={aapl} {...map({y: Plot.bollinger({n})}, {x: "Date", y: "Close", stroke: "blue"})} />
