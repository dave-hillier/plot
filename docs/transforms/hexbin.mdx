import {AxisX, AxisY, Circle, Dot, Geo, Hexbin, Hexgrid, Plot, Text, scale} from "replot/react";
...
<Plot color={{scheme: "turbo"}}>
  <Hexbin fill="count" r="count">
    <Dot data={olympians} x="weight" y="height" stroke="currentColor" />
  </Hexbin>
</Plot>
...
<Plot>
  <Hexbin fill="mode" r="count">
    <Dot data={olympians} x="weight" y="height" fill="sex" />
  </Hexbin>
</Plot>
...
<Plot>
  <Hexbin stroke="mode" r="count">
    <Dot data={olympians} x="weight" y="height" z="sex" stroke="sex" />
  </Hexbin>
</Plot>
...
<Plot>
  <Hexbin text="count">
    <Text data={olympians} x="weight" y="height" />
  </Hexbin>
</Plot>
...
<Plot>
  <Hexgrid />
  <Hexbin r="count">
    <Dot data={olympians} x="weight" y="height" fill="currentColor" />
  </Hexbin>
</Plot>
...
<Plot>
  <Hexbin r="count">
    <Circle data={olympians} x="weight" y="height" />
  </Hexbin>
</Plot>
