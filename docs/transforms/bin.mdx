import {AreaY, Dot, LineY, Plot, Rect, RectX, RectY, RuleX, RuleY, bin, binX, binY, scale} from "replot/react";
import * as d3 from "d3";
import {useState, useEffect} from "react";
import olympians from "../data/olympians.ts";

export const cumulatives = 0;
export const setCumulatives = () => {};
...
<Plot y={{grid: true}}>
  <RectY data={olympians} {...binX({y: "count"}, {x: "weight"})} />
  <RuleY data={[0]} />
</Plot>
...
<Plot color={{scheme: "turbo"}}>
  <Rect data={olympians} {...binX({fill: "count"}, {x: "weight"})} />
</Plot>
...
<Plot x={{grid: true}}>
  <RectX data={olympians} {...binY({x: "count"}, {y: "weight"})} />
  <RuleX data={[0]} />
</Plot>
...
<Plot color={{scheme: "turbo"}}>
  <Rect data={olympians} {...bin({fill: "count"}, {x: "weight", y: "height"})} />
</Plot>
...
<Plot y={{grid: true}}>
  <AreaY data={olympians} {...binX({y: "count", filter: null}, {x: "weight", fillOpacity: 0.2})} />
  <LineY data={olympians} {...binX({y: "count", filter: null}, {x: "weight"})} />
  <RuleY data={[0]} />
</Plot>
...
<Plot marginLeft={60} y={{grid: true}}>
  <RectY data={olympians} {...binX({y: "count"}, {x: "weight", cumulative})} />
  <RuleY data={[0]} />
</Plot>
...
<Plot marginLeft={100} padding={0} x={{grid: true}} fy={{domain: d3.groupSort(olympians.filter((d) => d.weight), (g) => d3.median(g, (d) => d.weight), (d) => d.sport)}} color={{scheme: "turbo"}}>
  <Rect data={olympians} {...binX({fill: "proportion-facet"}, {x: "weight", fy: "sport", inset: 0.5})} />
</Plot>
...
<Plot x={{round: true}} y={{grid: true}}>
  <RectY data={olympians} {...binX({y: "count"}, {x: "weight", inset: 0})} />
  <RuleY data={[0]} />
</Plot>
