import {DifferenceY, Plot, shiftX} from "replot/react";
import * as d3 from "d3";
import {useState, useEffect} from "react";
import aapl from "../data/aapl.ts";

export const shift = 365;
...
<Plot y={{grid: true}}>
  <DifferenceY data={aapl} {...shiftX(`${shift} days`, {x: "Date", y: "Close"})} />
</Plot>
...
## shiftY(*interval*, *options*) <VersionBadge version="0.6.16" pr="1922" />
```js
