import {Dot, Line, Plot, RuleX, RuleY, Text, groupY, normalizeY, selectLast, selectMinX} from "replot/react";
...
{/*
// TODO: manually convert: const xy = Plot.normalizeX("sum", {z: "state", x: "population", y: "state"});
// TODO: manually convert: Promise.all([
// TODO: manually convert: d3.csv("../data/aapl.csv", d3.autoType),
...
// TODO: manually convert: stocks.value = d3.zip(["AAPL", "AMZN", "GOOG", "IBM"], datas).flatMap(([Symbol, data]) => data.map((d) => ({Symbol, ...d})));
