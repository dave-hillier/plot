import {BarX, BarY, Cell, Dot, Group, GroupX, GroupY, Link, Plot, RuleX, RuleY, Text, filter, groupZ, stackX, scale} from "replot/react";
...
<Plot marginBottom={80} x={{tickRotate: 90}}>
  <GroupX fill="mode">
    <Cell data={olympians} fill="sex" x="sport" />
  </GroupX>
</Plot>
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{grid: true}} color={{legend: true}}>
  <GroupX y="count">
    <BarY data={olympians} x="sport" fill="sex" />
  </GroupX>
  <RuleY data={[0]} />
</Plot>
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{grid: true}} color={{legend: true}}>
  <GroupX y2="count">
    <BarY data={olympians} x="sport" fill="sex" mixBlendMode="multiply" />
  </GroupX>
  <RuleY data={[0]} />
</Plot>
...
<Plot marginBottom={100} fx={{padding: 0, label: null, tickRotate: 90, tickSize: 6}} x={{axis: null, paddingOuter: 0.2}} y={{grid: true}} color={{legend: true}}>
  <GroupX y2="count">
    <BarY data={olympians} x="sex" fx="sport" fill="sex" />
  </GroupX>
  <RuleY data={[0]} />
</Plot>
...
<Plot marginLeft={100} x={{grid: true}} y={{label: null}}>
  <GroupY x="count">
    <BarX data={olympians} y="sport" sort={{y: "x"}} />
  </GroupY>
  <RuleX data={[0]} />
</Plot>
...
<Plot marginBottom={80} x={{label: null, tickRotate: 90}} y={{label: null}} color={{label: "Median weight (kg)", legend: true, scheme: "turbo"}}>
  <Group fill="median">
    <Cell data={olympians} fill="weight" x="sport" y="sex" />
  </Group>
</Plot>
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{label: "gold", labelAnchor: "top", labelArrow: true, reverse: true}} color={{type: "sqrt", scheme: "turbo"}}>
  <Group fill="count">
    <Cell data={olympians} x="sport" y="gold" />
  </Group>
</Plot>
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{type: "point", label: "gold", labelAnchor: "top", labelArrow: true, reverse: true}} r={{range: [0, 12]}}>
  <Group r="count">
    <Dot data={olympians} x="sport" y="gold" />
  </Group>
</Plot>
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{type: "point", label: "gold", labelAnchor: "top", labelArrow: true, reverse: true}} r={{range: [0, 12]}}>
  <Group r="count">
    <Dot data={olympians} x="sport" y="gold" stroke="sex" />
  </Group>
</Plot>
