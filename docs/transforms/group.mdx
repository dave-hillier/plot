import {BarX, BarY, Cell, Dot, Link, Plot, RuleX, RuleY, Text, filter, group, groupX, groupY, stackX} from "replot/react";
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{grid: true}}>
  <BarY data={olympians} {...groupX({y: "count"}, {x: "sport"})} />
  <RuleY data={[0]} />
</Plot>
...
{/* <Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{grid: true}}>
  <BarY data={olympians} {...groupX({y: "count"}, {x: "sport", sort: {x: "-y"}})} />
  <RuleY data={[0]} />
</Plot> */}
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} r={{range: [0, 14]}}>
  <Dot data={olympians} {...groupX({r: "count"}, {x: "sport"})} />
</Plot>
...
<Plot marginBottom={80} x={{tickRotate: 90}} color={{scheme: "turbo"}}>
  <Cell data={olympians} {...groupX({fill: "count"}, {x: "sport"})} />
</Plot>
...
<Plot marginBottom={80} x={{tickRotate: 90}}>
  <Cell data={olympians} {...groupX({fill: "mode"}, {fill: "sex", x: "sport"})} />
</Plot>
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{grid: true}} color={{legend: true}}>
  <BarY data={olympians} {...groupX({y: "count"}, {x: "sport", fill: "sex"})} />
  <RuleY data={[0]} />
</Plot>
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{grid: true}} color={{legend: true}}>
  <BarY data={olympians} {...groupX({y2: "count"}, {x: "sport", fill: "sex", mixBlendMode: "multiply"})} />
  <RuleY data={[0]} />
</Plot>
...
<Plot marginBottom={100} fx={{padding: 0, label: null, tickRotate: 90, tickSize: 6}} x={{axis: null, paddingOuter: 0.2}} y={{grid: true}} color={{legend: true}}>
  <BarY data={olympians} {...groupX({y2: "count"}, {x: "sex", fx: "sport", fill: "sex"})} />
  <RuleY data={[0]} />
</Plot>
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{grid: true, label: "Frequency"}} color={{type: "categorical", domain: [-1, 1], unknown: "#aaa", transform: Math.sign}}>
  <RuleY data={[0]} />
  <Link data={olympians} {...groupX(
        {
...
<Plot marginLeft={100} x={{grid: true}} y={{label: null}}>
  <BarX data={olympians} {...groupY({x: "count"}, {y: "sport", sort: {y: "x"}})} />
  <RuleX data={[0]} />
</Plot>
...
<Plot marginBottom={80} x={{label: null, tickRotate: 90}} y={{label: null}} color={{label: "Median weight (kg)", legend: true, scheme: "turbo"}}>
  <Cell data={olympians} {...group({fill: "median"}, {fill: "weight", x: "sport", y: "sex"})} />
</Plot>
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{label: "gold", labelAnchor: "top", labelArrow: true, reverse: true}} color={{type: "sqrt", scheme: "turbo"}}>
  <Cell data={olympians} {...group({fill: "count"}, {x: "sport", y: "gold"})} />
</Plot>
...
<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{type: "point", label: "gold", labelAnchor: "top", labelArrow: true, reverse: true}} r={{range: [0, 12]}}>
  <Dot data={olympians} {...group({r: "count"}, {x: "sport", y: "gold"})} />
</Plot>

We can add the **stroke** channel to show overlapping distributions by sex.

<Plot marginBottom={100} x={{label: null, tickRotate: 90}} y={{type: "point", label: "gold", labelAnchor: "top", labelArrow: true, reverse: true}} r={{range: [0, 12]}}>
  <Dot data={olympians} {...group({r: "count"}, {x: "sport", y: "gold", stroke: "sex"})} />
</Plot>
...
<Plot height={100} x={{percent: true}}>
  <BarX data={olympians} {...stackX(
...
## find(*test*) <VersionBadge version="0.6.12" pr="1914" />
```js
Plot.groupX(
