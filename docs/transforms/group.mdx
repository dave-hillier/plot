import {BarX, BarY, Cell, Dot, Group, GroupX, GroupY, Link, Replot, RuleX, RuleY, Text, filter, groupZ, stackX, scale} from "replot/react";
...
<Replot marginBottom={80} x={{tickRotate: 90}} color={{scheme: "turbo"}}>
  <GroupX fill="count">
...
<Replot marginBottom={80} x={{label: null, tickRotate: 90}} y={{label: null}} color={{label: "Median weight (kg)", legend: true, scheme: "turbo"}}>
  <Group fill="median">
...
<Replot marginBottom={100} x={{label: null, tickRotate: 90}} y={{label: "gold", labelAnchor: "top", labelArrow: true, reverse: true}} color={{type: "sqrt", scheme: "turbo"}}>
  <Group fill="count">
