import {Dot, Link, Plot, Text, treeLink, treeNode} from "replot/react";
...
<Plot axis={null} height={100} margin={20} marginRight={120}>
  <Link data={gods} {...treeLink()} />
  <Dot data={gods} {...treeNode()} />
  <Text data={gods} {...treeNode({text: "node:name", dx: 6})} />
</Plot>
