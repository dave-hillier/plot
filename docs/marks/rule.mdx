import {BarY, Dot, Line, LineY, Plot, RuleX, RuleY, groupX, normalizeY} from "replot/react";
...
<Plot y={{
  ...
  <Line data={aapl} {...normalizeY("first", {x: "Date", y: "Close"})} />
</Plot>
...
<Plot y={{grid: true, label: "Temperature (°C)"}} color={{scheme: "BuRd"}}>
  <RuleY data={[0]} />
...
<Plot inset={6} label={null} y={{grid: true, label: "Stock price ($)"}} color={{type: "threshold", range: ["red", "green"]}}>
...
<Plot>
  ...
  <Dot data={simpsons} x="season" y="imdb_rating" fill="currentColor" stroke="var(--vp-c-bg)" />
  <LineY data={simpsons} {...groupX({y: "median"}, {x: "season", y: "imdb_rating", stroke: "red"})} />
</Plot>
