import {BarY, Dot, GroupX, Line, LineY, NormalizeY, Plot, RuleX, RuleY} from "replot/react";
...
<Plot>
  <GroupX y1="min" y2="max">
    <RuleX data={simpsons} x="season" y="imdb_rating" />
  </GroupX>
  <Dot data={simpsons} x="season" y="imdb_rating" fill="currentColor" stroke="var(--vp-c-bg)" />
  <GroupX y="median">
    <LineY data={simpsons} x="season" y="imdb_rating" stroke="red" />
  </GroupX>
</Plot>
