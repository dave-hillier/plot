import {AxisY, BarX, BarY, GridX, Plot, RuleX, Text, TextX, stackX} from "replot/react";
...
{/*
// TODO: manually convert: const timeseries = [
...
// TODO: manually convert: {year: 2020, population: 7794.798739}
...
<Plot marginLeft={60} x={{label: "Frequency"}} y={{label: null}} color={{legend: true}}>
...
<Plot marginLeft={130} axis={null} x={{
    axis: "top",
    grid: true,
...
<Plot x={{round: true, tickFormat: "d"}} color={{scheme: "BuRd"}}>
...
<Plot marginLeft={60} marginRight={60} label={null} x={{label: "Frequency"}} y={{padding: 0}}>
