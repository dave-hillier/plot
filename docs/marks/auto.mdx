import {Auto, Plot} from "replot/react";
...
<Plot>
  <Auto data={olympians} x="weight" y="height" color="count" />
</Plot>
...
<Plot>
  <Auto data={olympians} x="weight" y="sex" color="count" />
</Plot>
...
<Plot color={{legend: true}}>
  <Auto data={olympians} x="date_of_birth" y={{value: "height", reduce: "mean"}} color="sex" mark="line" />
</Plot>
...
<Plot grid x={{ticks: 5}} marginRight={70}>
...
## autoSpec(*data*, *options*) <VersionBadge version="0.6.4" />
```js
