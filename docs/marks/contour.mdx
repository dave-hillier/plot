import {Contour, Dot, Plot, Sphere, Text} from "replot/react";
...
<Plot color={{
  ...
  <Contour data={volcano.values} width={volcano.width} height={volcano.height} fill={Plot.identity} stroke="black" />
</Plot>
...
<Plot grid x={{domain: [0, grid.width], label: "column"}} y={{domain: [0, grid.height], label: "row"}}>
  <Text data={grid.values} text={Plot.identity} fill={Plot.identity} x={(d, i) => i % grid.width + 0.5} y={(d, i) => Math.floor(i / grid.width) + 0.5} />
</Plot>
...
<Plot>
  <Contour data={grid.values} width={grid.width} height={grid.height} fill={Plot.identity} interval={5} />
  <Text data={grid.values} text={Plot.identity} fill="white" x={(d, i) => i % grid.width + 0.5} y={(d, i) => Math.floor(i / grid.width) + 0.5} />
</Plot>
...
<Plot color={{type: "diverging"}}>
  <Dot data={ca55} x="LONGITUDE" y="LATITUDE" fill="MAG_IGRF90" />
</Plot>

Pass the same arguments to the contour mark for continuous contours.

<Plot color={{type: "diverging"}}>
  <Contour data={ca55} x="LONGITUDE" y="LATITUDE" fill="MAG_IGRF90" />
</Plot>
...
<Plot color={{type: "diverging"}}>
  <Contour data={ca55} x="LONGITUDE" y="LATITUDE" fill="MAG_IGRF90" blur={4} />
</Plot>
...
<Plot projection="equal-earth" color={{
  ...
  <Contour data={vapor} fill={Plot.identity} width={360} height={180} x1={-180} y1={90} x2={180} y2={-90} blur={1} stroke="black" strokeWidth={0.5} clip="sphere" />
  <Sphere stroke="black" />
</Plot>
...
<Plot aspectRatio={1} x={{tickSpacing: 80, label: "x"}} y={{tickSpacing: 80, label: "y"}} color={{type: "diverging", legend: true, label: "sin(x) cos(y)"}}>
