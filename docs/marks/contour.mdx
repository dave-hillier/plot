import {Contour, Dot, identity, Plot, Sphere, Text} from "replot/react";
...
<Plot projection="equal-earth" color={{
  ...
  <Contour data={vapor} fill={identity} width={360} height={180} x1={-180} y1={90} x2={180} y2={-90} blur={1} stroke="black" strokeWidth={0.5} clip="sphere" />
  <Sphere stroke="black" />
</Plot>
