import {Geo, Line, LineY, NormalizeY, Plot, RuleY, SelectLast, Text, WindowY} from "replot/react";
...
<Plot y={{
  ...
  <SelectLast>
    <NormalizeY>
      <Text data={stocks} x="Date" y="Close" z="Symbol" text="Symbol" textAnchor="start" dx={3} />
    </NormalizeY>
  </SelectLast>
</Plot>
