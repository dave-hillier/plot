import {Cell, formatMonth, formatWeekday, Group, Plot, Text} from "replot/react";
...
<Plot padding={0} x={{axis: null}} y={{tickFormat: formatWeekday("en", "narrow"), tickSize: 0}} fy={{tickFormat: ""}} color={{scheme: "PiYG"}}>
...
<Plot padding={0} y={{tickFormat: formatMonth("en", "short")}}>
  <Group fill="max">
