import {Cell, Plot, Text, group} from "replot/react";
...
<Plot padding={0} grid x={{axis: "top", label: "Season"}} y={{label: "Episode"}} color={{type: "linear", scheme: "PiYG"}}>
  <Cell data={simpsons} x="season" y="number_in_season" fill="imdb_rating" inset={0.5} />
  <Text data={simpsons} x="season" y="number_in_season" text={(d) => d.imdb_rating?.toFixed(1)} fill="black" title="title" />
</Plot>
...
<Plot padding={0} x={{axis: null}} y={{tickFormat: Plot.formatWeekday("en", "narrow"), tickSize: 0}} fy={{tickFormat: ""}} color={{scheme: "PiYG"}}>
...
<Plot padding={0} y={{tickFormat: Plot.formatMonth("en", "short")}}>
  <Cell data={seattle} {...group({fill: "max"}, {
