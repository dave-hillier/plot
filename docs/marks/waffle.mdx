import {AxisFx, GroupX, GroupZ, Plot, Text, WaffleX, WaffleY} from "replot/react";
...
<Plot fx={{interval: 10}} color={{legend: true}}>
  <GroupZ y="count">
    <WaffleY data={olympians} fill="sex" sort="sex" fx="weight" unit={10} />
  </GroupZ>
</Plot>
