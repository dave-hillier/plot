import {Dot, Line, Plot, Raster, Sphere, Text} from "replot/react";
...
<Plot color={{label: "Elevation (m)", legend: true}}>
...
<Plot color={{type: "diverging"}}>
  <Line data={ca55} x="LONGITUDE" y="LATITUDE" stroke="MAG_IGRF90" z="LINE_NUMB-SEG" />
</Plot>
...
<Plot color={{type: "diverging"}}>
  <Raster data={ca55} x="LONGITUDE" y="LATITUDE" fill="MAG_IGRF90" interpolate="nearest" />
</Plot>
...
<Plot color={{type: "diverging"}}>
  <Raster data={ca55} x="LONGITUDE" y="LATITUDE" fill="MAG_IGRF90" interpolate="barycentric" />
</Plot>
...
<Plot color={{type: "diverging"}}>
  <Raster data={ca55} x="LONGITUDE" y="LATITUDE" fill="MAG_IGRF90" interpolate="random-walk" />
</Plot>
...
<Plot color={{type: "diverging"}}>
  <Raster data={ca55} x="LONGITUDE" y="LATITUDE" fill="MAG_IGRF90" interpolate="random-walk" blur={5} />
</Plot>
...
<Plot projection="equal-earth" color={{
  ...
  <Raster data={vapor} fill={Plot.identity} width={360} height={180} x1={-180} y1={90} x2={180} y2={-90} interpolate="barycentric" clip="sphere" />
  <Sphere stroke="black" />
</Plot>
