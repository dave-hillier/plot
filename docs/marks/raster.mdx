import {Dot, identity, Line, Plot, Raster, Sphere, Text} from "replot/react";
...
<Plot projection="equal-earth" color={{
  ...
  <Raster data={vapor} fill={identity} width={360} height={180} x1={-180} y1={90} x2={180} y2={-90} interpolate="barycentric" clip="sphere" />
  <Sphere stroke="black" />
</Plot>
