import {Dot, Geo, Plot, RuleX, RuleY, Text, bin, geoCentroid, groupY, selectMinX, stackY2} from "replot/react";
...
{/*
// TODO: manually convert: const xy = Plot.normalizeX({basis: "sum", z: "state", x: "population", y: "state"});
