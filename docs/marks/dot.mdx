import {Bin, Dot, DotX, Geo, GeoCentroid, GroupY, Plot, RuleX, RuleY, SelectMinX, StackY2, Text, identity, normalizeX} from "replot/react";
...
<Plot height={640} marginLeft={60} grid x={{label: "Carats"}} y={{label: "Price ($)"}} r={{range: [0, 20]}}>
  <Bin r="count" thresholds={100}>
    <Dot data={diamonds} x="carat" y="price" />
  </Bin>
</Plot>
