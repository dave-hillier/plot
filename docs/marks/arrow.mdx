import {Arrow, Dot, Plot, Text} from "replot/react";
...
{/*
// TODO: manually convert: const markov = (() => {
// TODO: manually convert: const matrix = [[3, 2, 5], [1, 7, 2], [1, 1, 8]];
// TODO: manually convert: const nodes = matrix.map((m, i) => d3.pointRadial(((2 - i) * 2 * Math.PI) / matrix.length, 100));
// TODO: manually convert: const edges = matrix.flatMap((m, i) => m.map((value, j) => ([nodes[i], nodes[j], value])));
// TODO: manually convert: return {nodes, edges};
// TODO: manually convert: })();
// TODO: manually convert: function samegroup({source, target}) {
// TODO: manually convert: source = miserables.groups.get(source);
// TODO: manually convert: target = miserables.groups.get(target);
// TODO: manually convert: return source === target ? source : null;
*/}
...
<Plot inset={60} aspectRatio={1} axis={null}>
...
<Plot height={1080} marginLeft={100} axis={null} x={{domain: [0, 1]}} color={{domain: d3.range(10), unknown: "#ccc"}}>
