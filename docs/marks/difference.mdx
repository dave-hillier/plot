import {AxisY, DifferenceY, Plot, RuleY, shiftX, windowY} from "replot/react";
...
{/*
// TODO: manually convert: d3.csv("../data/sf-sj-temperatures.csv", d3.autoType).then((data) => (temperature.value = data.filter((d) => d.date.getUTCFullYear() === 2020)));
*/}
