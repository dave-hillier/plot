import {Bin, BinX, formatMonth, Plot, Rect, RectY, RuleY, StackX} from "replot/react";
...
<Plot>
  <BinX y="count">
    <RectY data={olympians} x="weight" fy="sex" />
  </BinX>
  <RuleY data={[0]} />
</Plot>
...
<Plot height={640} marginLeft={60} color={{
  ...
  <Bin fill="count" thresholds={100}>
    <Rect data={diamonds} x="carat" y="price" />
  </Bin>
</Plot>
...
<Plot aspectRatio={1} y={{ticks: 12, tickFormat: formatMonth("en", "narrow")}}>
...
<Plot color={{legend: true}}>
  <BinX y="count">
    <RectY data={olympians} x="weight" fill="sex" ry2={4} ry1={-4} clip="frame" />
  </BinX>
  <RuleY data={[0]} />
</Plot>
...
<Plot color={{legend: true}}>
  <BinX y="count">
    <RectY data={olympians} x="weight" fill="sex" rx1y2={10} rx1y1={-10} clip="frame" />
  </BinX>
  <RuleY data={[0]} />
</Plot>
