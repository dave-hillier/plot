import {Dot, Frame, Geo, LineY, Plot, RectY, Tip, binX, geoCentroid} from "replot/react";
...
{/* Data: states is loaded externally (GeoJSON features for US states). */}
...
<Plot grid>
  <Dot data={olympians} x="weight" y="height" fy="sex" sort={(d) => !!d.info} stroke={(d) => d.info ? "currentColor" : "#aaa"} />
  <Tip data={olympians} {...Plot.pointer({
      x: "weight",
      y: "height",
      fy: "sex",
      filter: (d) => d.info,
...
<Plot>
  <Dot data={olympians} x="weight" y="height" stroke="sex" channels={{name: "name", sport: "sport"}} tip />
</Plot>
...
<Plot>
  <RectY data={olympians} {...binX({y: "count"}, {x: "weight", fill: "sex", tip: true})} />
</Plot>
...
<Plot y={{label: "Frequency"}}>
  <RectY data={olympians} {...binX({y: "sum"}, {x: "weight", y: (d) => d.sex === "male" ? 1 : -1, fill: "sex", tip: true})} />
</Plot>
...
<Plot>
  <Dot data={olympians} x="weight" y="height" stroke="sex" channels={{name: "name", nationality: {value: "nationality", label: "country"}, sport: "sport"}} tip={{format: {name: true, sport: true, nationality: true, y: (d) => `${d}m`, x: (d) => `${d}kg`, stroke: false}}} />
</Plot>
...
<Plot projection="albers-usa">
  <Geo data={states} />
  <Tip data={states} {...geoCentroid({title: (d) => d.properties.name, anchor: "bottom", textPadding: 3})} />
</Plot>
