import {AxisFx, AxisX, AxisY, BarX, BarY, Dot, Frame, GridX, GridY, Line, Plot, RuleX, RuleY} from "replot/react";
...
export const facetAnchor = "auto";
export const setFacetAnchor = () => {};
export const responses = [];

{/*
// TODO: manually convert: const responses = [





// TODO: manually convert: {name: "Not enough politics", value: 0.12}
...
<Plot x={{percent: true, grid: true, axis: "both"}}>
...
<Plot marginTop={0} marginLeft={4} x={{ticks: 4, label: "Yield (kg)"}}>
...
<Plot x={{round: true, nice: d3.utcWeek}} y={{inset: 6}}>
...
<Plot height={40} style={{background: "#777"}} x={{domain: [0, 100]}}>
...
<Plot facet={{marginRight: 80}} grid>
  <Frame />
...
<Plot height={80} grid x={{type: "linear"}}>
