import {Dot, Geo, Link, Plot, Sphere, Text, treeLink, treeNode} from "replot/react";
...
{/*
// TODO: manually convert: const xy = {x1: -122.4194, y1: 37.7749, x2: 2.3522, y2: 48.8566};
// TODO: manually convert: const gods = ["Chaos/Gaia/Mountains", "Chaos/Gaia/Pontus", "Chaos/Gaia/Uranus", "Chaos/Eros", "Chaos/Erebus", "Chaos/Tartarus"];
*/}
...
<Plot axis={null} height={120} inset={20} insetRight={120}>
...
<Plot aspectRatio={1} marginRight={40} x={{
