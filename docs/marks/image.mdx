import {Dot, Frame, Image, Plot, RuleX, RuleY, dodgeY} from "replot/react";
...
<Plot inset={20} x={{label: "First inauguration date"}} y={{grid: true, label: "Net favorability (%)", tickFormat: "+f"}}>
  <RuleY data={[0]} />
...
<Plot x={{inset: 20, label: "First inauguration date"}} y={{insetTop: 4, grid: true, label: "Any opinion (%)", tickFormat: "+f"}}>
  <RuleY data={[0]} />
...
<Plot inset={20} height={280}>
  <Image data={presidents} {...dodgeY({
...
<Plot aspectRatio={1} grid x={{label: "Favorable opinion (%)"}} y={{label: "Unfavorable opinion (%)"}}>
  <RuleY data={[0]} />
  <RuleX data={[0]} />
...
<Plot margin={30} inset={10} grid style={{
    padding: "10px",
    color: "black",
